...
import info.imdang.local.constant.PREF_SOCIAL_ACCESS_TOKEN_KEY
...
internal class AuthLocalDataSourceImpl @Inject constructor(
    ...
    override fun saveSocialAccessToken(accessToken: String) {
        sharedPreferences.edit().putString(PREF_SOCIAL_ACCESS_TOKEN_KEY, accessToken).apply()
    }

    override fun getSocialAccessToken(): String =
        sharedPreferences.getString(PREF_SOCIAL_ACCESS_TOKEN_KEY, "") ?: ""
}
