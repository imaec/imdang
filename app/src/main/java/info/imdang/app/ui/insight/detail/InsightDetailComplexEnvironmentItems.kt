...
@Composable
fun InsightDetailComplexEnvironmentItems(
    building: String,
    safety: String,
    childrenFacility: String,
    silverFacility: String,
    complexEnvironmentReview: String
) {
    Column {
        Column(
            modifier = Modifier
