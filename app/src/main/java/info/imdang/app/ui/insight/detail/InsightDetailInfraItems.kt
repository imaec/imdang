...
@Composable
fun InsightDetailInfraItems(
    traffics: List<String>,
    schools: List<String>,
    livingFacilities: List<String>,
    cultureFacilities: List<String>,
    surroundingEnvironments: List<String>,
    landmarks: List<String>,
    avoidFacilities: List<String>,
    infraReview: String
) {
    Column {
        Column(
